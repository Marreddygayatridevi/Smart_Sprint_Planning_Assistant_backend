...
#         """Save assignments to database with overwrite logic for reassignments"""
#         if not assignments:
...
#             for assignment in assignments:
#                 # Check if assignment exists for this issue_key and sprint_name
#                 existing = db.execute(text("""
#                     SELECT id, assignee_name FROM sprints 
#                     WHERE issue_key = :issue_key AND sprint_name = :sprint_name
#                     LIMIT 1
#                 """), {
...
#                 if existing:
#                     existing_id, existing_assignee = existing
                    
#                     # Check if assignee is different (reassignment case)
#                     if existing_assignee != assignment.assignee_name:
#                         # UPDATE existing assignment with new assignee and details
#                         db.execute(text("""
#                             UPDATE sprints SET
#                                 assignee_name = :assignee_name,
#                                 title = :title,
...
#                     else:
#                         # Same assignee, just update other details if needed
#                         db.execute(text("""
#                             UPDATE sprints SET
#                                 title = :title,
#                                 estimated_days = :estimated_days,
